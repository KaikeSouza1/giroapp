    ...
    try {
      ...
      try {
        ...
        if (fetchErr.name === "AbortError") {
          console.warn(
            "Timeout offline alcançado no salvamento principal. Ignorando e seguindo."
          );
        } else {
          throw fetchErr;
        }
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden px-5 pt-12 pb-6">
        ...
        <p className="relative text-white/40 text-sm font-semibold mt-1">
          {meta.label}
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 px-5 mt-4">
        {[
          ...
          {
            label: "Pace médio",
            value: `${formatPace(avgPaceSec)} /km`,
            icon: "⚡",
          },
          {
            label: "Velocidade",
