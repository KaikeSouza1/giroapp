...
// ─── TAB BAR (exportado para reuso nas outras páginas) ─────────────────────────
...
export function TabBar({ active }: { active: 'home' | 'feed' | 'profile' }) {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-3 z-50"
