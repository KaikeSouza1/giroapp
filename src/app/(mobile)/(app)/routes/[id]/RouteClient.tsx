...
export default function RouteClient({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!route) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white gap-4 px-6">
      ...
      <Link href="/home" className="text-sm font-bold" style={{ color: '#E05300' }}>← Voltar</Link>
    </div>
  )
      ...
      <div className="px-5 pt-5 pb-32">
        <div className="flex items-start justify-between gap-3 mb-2">
          ...
          <span
            ...
            style={{ background: `${difficultyColor[route.difficulty]}15`, color: difficultyColor[route.difficulty] }}
          >
                ...
                {route.waypoints.map((wp, i) => (
                  <div key={wp.id} className="flex items-start gap-4 py-3 relative">
                    <div
                      ...
                      style={{
                        background: i === 0 ? '#830200' : i === route.waypoints.length - 1 ? '#22c55e' : '#E05300'
                      }}
                    >
