  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-[family-name:var(--font-dm)]">
      ...
      >
        ...
        >
          <path
            d="M0,120 Q93,80 187,120 Q280,160 375,120"
            fill="none"
            stroke="#fff"
            strokeWidth="1.5"
          />
          <path
            d="M0,80 Q93,40 187,80 Q280,120 375,80"
            fill="none"
            stroke="#fff"
            strokeWidth="1"
          />
          <path
            d="M0,160 Q93,120 187,160 Q280,200 375,160"
            fill="none"
            stroke="#fff"
            strokeWidth="1"
          />
          <path
            d="M0,40 Q93,80 187,40 Q280,0 375,40"
            fill="none"
            stroke="#fff"
            strokeWidth="0.7"
          />
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-sm mt-1">Entre para continuar</p>
        </div>
