  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#F9F9F9" }}>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(160deg, #830200 0%, #E05300 60%, #FF8C00 100%)",
        }}
      >
        <svg
        ...
        >
          <path
            d="M0,200 Q150,120 300,200 Q450,280 600,200"
            fill="none"
            stroke="#fff"
            strokeWidth="2"
          />
          <path
            d="M0,350 Q150,270 300,350 Q450,430 600,350"
            fill="none"
            stroke="#fff"
            strokeWidth="1.5"
          />
          <path
            d="M0,500 Q150,420 300,500 Q450,580 600,500"
            fill="none"
            stroke="#fff"
            strokeWidth="1.5"
          />
          <path
            d="M0,650 Q150,570 300,650 Q450,730 600,650"
            fill="none"
            stroke="#fff"
            strokeWidth="1"
          />
          <path
            d="M0,100 Q150,180 300,100 Q450,20 600,100"
            fill="none"
            stroke="#fff"
            strokeWidth="1"
          />
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-400 text-sm mb-8">
            Acesso exclusivo para parceiros e administradores
          </p>
