...
export default function NewRoutePage() {
  ...
  // Inicializa o mapa Leaflet (client-side only)
  useEffect(() => {
    ...
    async function initMap() {
      ...
      const map = L.map(mapContainerRef.current!, {
        center: [-27.5954, -48.548],  // Florianópolis como centro padrão
        zoom: 13,
      })
      ...
      map.on('click', (e: any) => {
        ...
        setWaypoints(prev => {
          const updated = [...prev, { ...newWaypoint, order: prev.length + 1 }]
          return updated
        })
  ...
  // Atualiza marcadores no mapa quando waypoints mudam
  useEffect(() => {
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      placeholder="Ex: Trilha da Serra Catarinense"
                      className="w-full px-4 py-3 rounded-xl text-sm text-gray-800 placeholder-gray-400 outline-none transition-all"
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      placeholder="Descreva a rota, pontos de interesse, dicas..."
                      rows={3}
                      className="w-full px-4 py-3 rounded-xl text-sm text-gray-800 placeholder-gray-400 outline-none transition-all resize-none"
                      style={{ background: '#F7F7F7', border: '1.5px solid #EFEFEF' }}
                    />
                  </div>
                  ...
                  <div className="rounded-2xl p-4 mt-2"
                    ...
                    <p className="text-xs font-bold text-orange-800 mb-1">💡 Como adicionar waypoints</p>
                    <p className="text-xs text-orange-700/70 leading-relaxed">
                      Clique em qualquer ponto do mapa ao lado para marcar um waypoint. Depois nomeie cada ponto na aba "Waypoints".
                    </p>
                  </div>
                </div>
              )}
